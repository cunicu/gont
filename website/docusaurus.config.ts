...
const config: Config = {
  title: 'Gont',
  tagline: 'A testing framework for distributed Go applications',
  favicon: 'img/favicon.ico',

  // Set the production url of your site here
  url: 'https://gont.cunicu.li',
  ...
  projectName: 'gont', // Usually your repo name.
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} cunicu.`,
    },
    prism: {
