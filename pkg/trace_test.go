...
func TestTraceInSameProcess(t *testing.T) {
	...
	require.Equal(t, event.Function, "github.com/stv0g/gont/pkg_test.TestTraceInSameProcess", "Wrong function name")
}
...
func TestTraceDissector(t *testing.T) {
	...
	require.Equal(t, trace.Function, "github.com/stv0g/gont/pkg_test.TestTraceDissector")
