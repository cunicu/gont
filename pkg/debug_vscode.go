...
var errNoWorkspaceDir = errors.New("failed to find workspace directory")
...
func (d *Debugger) WriteVSCodeConfigs(dir string, _ bool /* stopOnEntry */) error {
	if dir == "" {
		wd, err := os.Getwd()
		if err != nil {
